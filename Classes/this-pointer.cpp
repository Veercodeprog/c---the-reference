// each class member function contains a hidden pointer called this pointer.That
// pointer contains the address of the current object, for which the method is
// being executed.This also applies to constructors and destructors.
#include <iostream>
...
int main() {
  ...
  */
  ...
  // Chained calls using pointers
  // dog1.set_dog_name("Pumba")->set_dog_breed("Wire Fox
  // Terrier")->set_dog_age(4);
