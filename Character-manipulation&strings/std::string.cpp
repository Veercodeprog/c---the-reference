/*
 *character arrays:
 * character arrays are not strings
 * should be checked for out of bounds
 * remember to keep track of the null terminator or null character
 * std::string is a class that encapsulates a character array
 * std::string is a safer and more flexible alternative to character arrays
 * std::string is a part of the C++ standard library
 */
...
int main() {
  ...
  std::string weird_message(4,
                            'e'); // Initialize with multiple copies of a char
                                  //  contains eeee
  std::string greeting{"Hello World"};
  std::string saying_hello{
      greeting, 6, 5}; // Initialize with part of an existing std::string
  ...
  planet =
      "Earth. Where the sky is blue Earth. Where the sky is blue Earth. Where ";
  std::cout << "planet : " << planet << std::endl;
