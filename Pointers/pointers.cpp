...
std::cout << "p_int_var(Value stored at the address): " << *p_int_var << std::endl;
std::cout << "&int_var: " << &int_var << std::endl;
...
//pointers only store the type of the variable they are pointing to or for which it is declared
...
std::cout << "size of (p_fractional_number1) :" << sizeof(p_fractional_number1) << std::endl;	
